  ...
  return (
    <>
      ...
      >
        ...
        <div >
          <div class="bg-gray-200 opacity-80  shadow-2xl rounded-2xl" >
            <div class="flex">
              <div>
              </div>
              <div class="w-full p-8 ">
                <div class="flex justify-between">
                  ...
                  {/* like function */}
                  <div class="text-black py-1 pl-2" id='heart'>
                ...
                <div class="flex justify-between items-center mt-8">
                  ...
                  <div class="text-grey-darker" id='suffle'>
                  ...
                  <div class="text-black" id='back a track'>
                  ...
                  <div class="text-white p-8 rounded-full bg-black shadow-lg" id='play'>
                  ...
                  <div class="text-grey-darker" id='forward'>
                  ...
                  <div class="text-grey-darker" id='repeat'>
